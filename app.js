...
var hearthContoller = require('./controllers/hearthtracker');
 ...
 * Game route
 */ 
app.post('/game', userController.postGameStart)

//game commands
app.post('/game/test', userController.postGameTest)

/**
 * Hearthstone Tracker Route
 */ 
